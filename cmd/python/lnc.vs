...
set shortmess=aoO
badd +43 cmd/python/simulation_post_processing.py
badd +51 cmd/python/retrieve_simulation_data.py
badd +55 cmd/python/glooper_launcher.py
badd +63 cmd/c++/glooper/glooper.cxx
badd +1 cmd/c++/glooper/test.cxx
badd +1 cmd/c++/Makefile
badd +0 cmd/python/simulation_post_processing.py
args cmd/python/simulation_post_processing.py
edit cmd/python/retrieve_simulation_data.py
...
silent! normal! zE
let s:l = 51 - ((5 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
51
normal! 0
lcd ~/Projects/glooper/cmd/python
tabedit ~/Projects/glooper/cmd/python/simulation_post_processing.py
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 43 - ((33 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
43
normal! 0
lcd ~/Projects/glooper/cmd/python
tabedit ~/Projects/glooper/cmd/python/glooper_launcher.py
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 55 - ((5 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
55
normal! 015l
lcd ~/Projects/glooper/cmd/python
tabedit ~/Projects/glooper/cmd/c++/glooper/glooper.cxx
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 63 - ((20 * winheight(0) + 20) / 41)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
63
normal! 0
lcd ~/Projects/glooper/cmd/c++/glooper
tabedit ~/Projects/glooper/cmd/c++/Makefile
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
